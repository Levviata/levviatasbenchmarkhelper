...
import com.levviata.benchmarkhelper.gui.BenchmarkConfigScreen;
...
public class BenchmarkButtonHandler
{
    ...
    public void onGuiInit(InitGuiEvent.Post event)
    {
        ...
        if (event.getGui() instanceof GuiWorldSelection)
        {
            ...
            int benchmarkButtonWidth =
                    Minecraft.getMinecraft().fontRenderer.getStringWidth(benchmarkButtonText) + 20;
            // Add a custom button
    ...
    public void onActionPerformed(GuiScreenEvent.ActionPerformedEvent.Post event)
    {
        ...
        if (event.getGui() instanceof GuiWorldSelection)
        {
            ...
            {
                // Open config screen
                Minecraft.getMinecraft().displayGuiScreen(new BenchmarkConfigScreen());
            }
        }
    }
}